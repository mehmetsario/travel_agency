	...
	<body class="slider-collapse">
		...
		<div id="site-content">
			...
			<header class="site-header wow fadeInDown">
				<div class="container">
					<div class="header-content">
						<div class="branding">
							<img src="{{asset('assets/images/logo.png')}}" alt="Company Name" class="logo">
			...
			<main class="content">
				<div class="slider">
					<ul class="slides">
						<li data-background="{{asset('assets/dummy/slide-1.jpg')}}">
							<div class="container">
						...
						<li data-background="{{asset('assets/dummy/slide-2.jpg')}}">
							<div class="container">
								<div class="slide-caption col-md-4">
									<h2 class="slide-title">Venenatis felis pulvinar ultrices</h2>
						...
						<li data-background="{{asset('assets/dummy/slide-3.jpg')}}">
							<div class="container">
								<div class="slide-caption col-md-4">
									<h2 class="slide-title">Venenatis felis pulvinar ultrices</h2>
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn">
									<figure class="featured-image"><img src="{{asset('assets/dummy/offer-thumbnail-1.jpg')}}" alt=""></figure>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn" data-wow-delay=".2s">
									<figure class="featured-image"><img src="{{asset('assets/dummy/offer-thumbnail-2.jpg')}}" alt=""></figure>
									<h2 class="entry-title"><a href="">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="#" class="button">See details</a>
								</article>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn" data-wow-delay=".4s">
									<figure class="featured-image"><img src="{{asset('assets/dummy/offer-thumbnail-3.jpg')}}" alt=""></figure>
									<h2 class="entry-title"><a href="">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="#" class="button">See details</a>
								</article>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn" data-wow-delay=".6s">
									<figure class="featured-image"><img src="{{asset('assets/dummy/offer-thumbnail-4.jpg')}}" alt=""></figure>
									<h2 class="entry-title"><a href="">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="#" class="button">See details</a>
								</article>
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp">')}}
									<figure class="avatar"><img src="{{asset('assets/dummy/person-1.jpg')}}" alt=""></figure>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp" data-wow-delay=".2s">
									<figure class="avatar"><img src="{{asset('assets/dummy/person-2.jpg')}}" alt=""></figure>
									<blockquote class="testimonial-body">
										<p>Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp" data-wow-delay=".4s">
									<figure class="avatar"><img src="{{asset('assets/dummy/person-3.jpg')}}" alt=""></figure>
									<blockquote class="testimonial-body">
										<p>Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp" data-wow-delay=".6s">
									<figure class="avatar"><img src="{{asset('assets/dummy/person-4.jpg')}}" alt=""></figure>
									<blockquote class="testimonial-body">
										<p>Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-6">
								<div class="widget widget-customer-info">
									...
									<img src="{{asset('assets/dummy/footer-customer-service.jpg')}}" alt="" class="pull-left">
									<div class="cs-info">
				...
				<div class="footer-bottom">
					<div class="container">
						<div class="branding pull-left">
							<img src="{{asset('assets/images/logo-footer.png')}}" alt="Company Name" class="logo">
							<h1 class="site-title"><a href="index.html">Company Name</a></h1>
							<small class="site-description">Tagline goes here</small>
						</div>
